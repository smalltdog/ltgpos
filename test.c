...
int main()
{
    F* dChiOutFst, * dChiOutSec, * hChiOutFst, * hChiOutSec;
    dChiOutFst = cudamallocResBytes();
    dChiOutSec = cudamallocResBytes();
    hChiOutFst = mallocResBytes();
    hChiOutSec = mallocResBytes();
    printf("%s", ltgPosition("[{\"datetime\": \"2020-11-23 01:01:12\", \"longitude\": 119.8493, \"latitude\": 29.5466, \"microsecond\": 2330000, \"node\": \"waibiwaibi\", \"signal_strength\":1},"
                             ...
                             dChiOutFst, dChiOutSec, hChiOutFst, hChiOutSec
                            ));
}
